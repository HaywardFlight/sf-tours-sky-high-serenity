...
import { BOOKING_LINKS, getTourOptions, formatPrice, type TourKey } from "@/data/bookingLinks";

const tourImages: Record<TourKey, string> = {
  bay: tourBayArea,
  elite: tourElite,
  sunset: tourSunset,
  night: tourNight,
...
const tourDescriptions: Record<TourKey, string> = {
  bay: `Take a 40-minute flight over San Francisco for the best views of the city and the bay. You will fly directly out to the Pacific Coast and the Golden Gate Bridge. After flying over the bridge you will continue your flight over Downtown San Francisco, along the waterfront, Fisherman's Wharf, and Pier 39.
...
Your departure and arrival location will be at the Hayward Executive Airport (KHWD), near the San Mateo Bridge.`,
  elite: `If 40 minutes is not enough to satisfy your need to explore San Francisco from the air, then the Elite SF Bay Tour package is for you! Your journey begins at Hayward Executive Airport as you climb aboard a Cessna 172 Skyhawk, with seats for 3 passengers in addition to the pilot.
...
Our experienced pilots will make the flight truly unforgettable, giving you plenty of opportunities to take stunning aerial pictures of the sights of the beautiful bay city as you fly over them.`,
  sunset: `The San Francisco Sunset Tour is one of the most unforgettable experiences that we offer. Perfect for couples, anniversaries, flying enthusiasts, or anyone who wants to experience the beauty of the San Francisco sunset from the air.
...
Admire as the brilliant red horizon clashes with the well-lit Downtown San Francisco. Our skilled pilots will expertly maneuver your airplane to allow you to enjoy and photograph the best views SF has to offer.`,
  night: `Take a plane over the SF bay area at night to get the best views of the city lights and the bay bridge light show. Get a unique perspective on San Francisco as you take in the city from the air. Enjoy a private plane all to yourselves for a truly romantic experience as you admire the night sky.
...
Continue your flight over Downtown San Francisco, spotting the city's main attractions from the air. Then, follow the waterfront, admiring the city's lights as you fly. Take in the popular tourist attraction of Fisherman's Wharf and Pier 39 before landing back at the airport.`,
  napa: `Admire the endless vineyards of Napa Valley from a new perspective. Relax as our pilots fly you over Wine Country so you can enjoy the best views Napa has to offer. If you love greenery and experiencing the beauty of nature, this will be an unforgettable experience you won't regret!`,
};

const tourKeys: TourKey[] = ["bay", "elite", "sunset", "night", "napa"];
                  ...
                  <div className={`${index % 2 === 1 ? "lg:order-1" : ""}`}>
                    ...
                    <div className="space-y-3">
                      <div className="flex flex-wrap gap-3">
                        {tour.options.map(({ passengers, price, url }) => (
                          <Button
                            key={passengers}
                            asChild
                            variant="gold"
